...
# 100-epoch synthetic thesis benchmark.
#
# First run:
#   r30 d16 fvdb -> spconv
#
...
#   git pull
#   bash scripts/run_may19_100ep_alternating_fvdb_spconv_local.sh
#
# Override local storage if needed:
#   RESULT_ROOT="/var/tmp/${USER}_runs/NEURALPVS_100EP" \
#   bash scripts/run_may19_100ep_alternating_fvdb_spconv_local.sh

SOURCE_ROOT="${SOURCE_ROOT:-/home/atighedl/May9_lunch_1000framescodexparamters/SceneGeneration}"
RESULT_ROOT="${RESULT_ROOT:-/var/tmp/${USER}_runs/NEURALPVS_MAY19_SYNTHETIC_100EP}"
